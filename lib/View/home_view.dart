import 'package:abdallah_al/view_model/app_links.dart';
...
class _HomeViewState extends State<HomeView> {
  ...
  ChatUser(id: "1", firstName: "Abdallah", lastName: "Mmdouh");
  final ChatUser gptUser =
  ChatUser(id: "2", firstName: "Chatbot", lastName: "Abdallah Ai");
    ...
    if (chat.isNotEmpty) {
      ...
      setState(() {
        messageList = messages.map((message) {
          ...
          return ChatMessage(
            user: parts[0] == 'Abdallah' ? currentUser : gptUser,
        ...
        child: ListView(
          ...
          children: [
             UserAccountsDrawerHeader(
                ...
                accountName: Text("Abdallah Mmdouh"),

                currentAccountPicture: CircleAvatar(
                  backgroundColor: Colors.white,
                  child: Image.asset("images/IMG_9848.JPG",width: 60,height: 60,),
                ),
